  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold font-display ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-secondary text-secondary-foreground hover:bg-warm-dark hover:text-primary-foreground shadow-warm hover:shadow-lg transform hover:-translate-y-0.5",
        heroOutline: "border-2 border-secondary bg-transparent text-secondary hover:bg-secondary hover:text-secondary-foreground",
        warm: "bg-secondary text-secondary-foreground hover:bg-warm-dark shadow-sm hover:shadow-md",
        slate: "bg-slate text-primary-foreground hover:bg-slate-dark shadow-sm hover:shadow-md",
      },
      size: {
